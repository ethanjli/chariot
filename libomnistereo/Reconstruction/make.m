...
if (isunix == 1)
    mex ('sgbm_mex.cpp',['-Wl,-rpath,', opts.sys_lib_dir],sprintf('%s/mc_convert/mc_convert/mc_convert.cpp',opts.root_dir), ...
        ['-I',sprintf('%s/mc_convert/mc_convert',opts.root_dir)], '-DHAS_OPENCV', ...
    ...
    mex('sgbm_mex.cpp', sprintf('%s/mc_convert/mc_convert/mc_convert.cpp',opts.root_dir), ...
        ['-I"',sprintf('%s/mc_convert/mc_convert',opts.root_dir),'"'],'-DHAS_OPENCV', ...
        ['-I"',opts.opencv_inc_dir,'"'],['-L"',opts.opencv_lib_dir,'"'], ...
