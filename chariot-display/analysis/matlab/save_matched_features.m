function h = saveMatchedFeatures(I1, I2, pts1, pts2, varargin)
...
%    Default: 'falsecolor'
%
%  showMatchedFeatures(...,'PlotOptions', {
%MarkerStyle1, MarkerStyle2, 
%  LineStyle
%}) lets you specify custom plot options in a cell array 
%  containing three string values, {
%MarkerStyle1, MarkerStyle2, LineStyle
%},
